...
## [Unreleased]
### Added
- Storing dump files in directory.
- Adding this directory to .gitignore.
- Exporting dump in non-interactive mode to use it programmatically, for example, to schedule backuping every day by Cron.
